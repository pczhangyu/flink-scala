package com.travelsky.flink.stream
...
object Kafka010Example {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val messageStream2 = env.addSource(kafkaConsumer).flatMap(in => prefix + in)
    ...
    val kafkaProducer = new FlinkKafkaProducer010(
      ...
      new SimpleStringSchema,
      params.getProperties)
//    messageStream2.addSink(new FlinkKafkaProducer010[String]("test_aaa",new SimpleStringSchema,params.getProperties))
